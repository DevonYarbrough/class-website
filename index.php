            ...
            <li> Commercial: Photoshoots for commercial clothing stores like Old Navy, Dillards, etc... You don't
              ...
              <li> Runway: Walking the runway is the modeling dream. Runway models are usually at or above
                ...
                <p>
                  ...
                  required. There are plenty of models who travel several hours to attend a shoot.
                  Finally, realize what you're signing up for. Modeling isn't glitz and glamor all the time. The industry is riddled
                ...
                <article class="col-md-4">
                  ...
                  <p> Do you have what it takes to be a model? For fashion, the requirements are strict, although there are
                    exceptions.</p>
                    <ul>
                      <li> At least 5'8 </li>
                    ...
                    Meet all of the above? Click here for how to contact agencies.</p>
                  </article>
                  <article class="col-md-4">
                    ...
                    <p>The first big step into the modeling world is contacting agencies. Agencies run your career for you by
                      ...
                      likely at least one will respond.</p>
                      ...
                      shots will cover almost any agency requirements:</p>
                      <ul>
                      ...
                      vital to only do what you are comfortable with, and it's never too late to start early.</p>
                    </article>
                  </section>
                </main>
                <footer class="col-md-12"> Here's my footer</footer>
              </body>
              </html>